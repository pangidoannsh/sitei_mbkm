...
<a href="{{route('staff.createmhs')}}" class="btn mahasiswa btn-success mb-3">+ Mahasiswa</a>
    ...
    @foreach ($mahasiswa as $mhs)
        <tr>
          ...
          <td class="text-center">
            <a href="/staff/mahasiswa/edit/{{$mhs->id}}" class="badge bg-warning"><i class="fas fa-pen"></i></a>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <form action="/staff/mahasiswa/{{$mhs->id}}" method="POST" class="d-inline">
                      @method('delete')
                      @csrf
